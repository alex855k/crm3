    ...
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/content/smartadmin")
                .Include("~/content/css/crm-styles.css")
                .Include("~/scripts/plugin/toastr/toastr.min.css")
                .Include("~/scripts/plugin/bootstrap-datepicker/css/bootstrap-datepicker.min.css")
            ...
            bundles.Add(new ScriptBundle("~/scripts/smartadmin").Include(
                ...
                "~/scripts/plugin/jquery-validate/additional-methods.min",
                "~/scripts/plugin/jquery-validate-unobtrusive/jquery.validate.unobtrusive.min.js",
            ...
            bundles.Add(new ScriptBundle("~/scripts/full-calendar").Include(
                "~/scripts/plugin/moment/moment.min.js",
                 "~/scripts/plugin/fullcalendar/fullcalendar.min.js",
                 "~/scripts/plugin/fullcalendar/lang/da.js"
                ));

            bundles.Add(new ScriptBundle("~/scripts/bootstrap-datepicker").Include(
                "~/scripts/plugin/bootstrap-datepicker/js/bootstrap-datepicker.min.js"
               ));
