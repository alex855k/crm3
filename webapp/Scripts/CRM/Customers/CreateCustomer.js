$(document).ready(function () {
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    if (response.TransactionType == TransactionType[TransactionType.Create]) {
                        if (!navigateToNotesAfterSave) {
                            ...
                            toastr.success("<span>Page will redirect to customer notes<span>", response.ResponseMessage, { timeOut: 2000 });
    ...
    $("#customerContactsLi").click(function () {
        $.ajax({
    ...
    $(document).on("click", "#customerCasesLi", function () {
        $.ajax({
    ...
    $(".customerColor").change(function (e) {
