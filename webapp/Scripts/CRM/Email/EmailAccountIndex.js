$().ready(() => {
    ...
    function Search(forceSearch, pageNumber) {
        ...
        $.ajax({
            url: "/EmailAccounts/DynamicTable",
            data: { "emailAccountViewModel": searchObject },
            type: "POST",
            success: function (data, textStatus, jqXHR) {
                debugger;
                $("#emailaccountsListDiv").html(data.tablePartial);
                $("#emailaccountsPaginationDiv").html(data.pagingPartial);
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                toastr.error("failed to load emailaccounts");
            }
        });
    }
    initQtip();
